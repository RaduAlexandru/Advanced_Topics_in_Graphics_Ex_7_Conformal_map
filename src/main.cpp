...
void exercise1()
{
    ...
    // //show it
    // igl::viewer::Viewer viewer_test;
    // viewer_test.core.point_size=1;
    // viewer_test.data.set_mesh(V,F);
    // viewer_test.launch();
...
void exercise2(const std::string &filename1){
    ...
    viewer.data.set_mesh(uv_uniform_spring, F);
    viewer.data.set_colors(colors);
    viewer.data.add_points(circle, Eigen::RowVector3d(0.0, 1.0, 0.0));
    ...
    viewer.data.set_mesh(uv_chordal_spring, F);
    viewer.data.set_colors(colors);
    viewer.data.add_points(circle, Eigen::RowVector3d(0.0, 1.0, 0.0));
    viewer.core.point_size = 3.0;
    viewer.launch();
    ...
    viewer.data.set_mesh(uv_wachspress, F);
    viewer.data.set_colors(colors);
    viewer.data.add_points(circle, Eigen::RowVector3d(0.0, 1.0, 0.0));
    viewer.core.point_size = 3.0;
    viewer.launch();
    ...
    viewer.data.set_mesh(uv_discrete_harmonic, F);
    viewer.data.set_colors(colors);
    viewer.data.add_points(circle, Eigen::RowVector3d(0.0, 1.0, 0.0));
    viewer.core.point_size = 3.0;
    viewer.launch();
    ...
    viewer.data.set_mesh(uv_mean_value, F);
    viewer.data.set_colors(colors);
    viewer.data.add_points(circle, Eigen::RowVector3d(0.0, 1.0, 0.0));
    viewer.core.point_size = 3.0;
    viewer.launch();
    ...
    viewer.data.set_mesh(uv_lscm, F);
    viewer.data.set_colors(colors);
    viewer.launch();
    }
